...
//   const [showGraphComunidades, setShowGraphComunidades] = useState(false);
  

//   const [displayGrafoComunidades, setdisplayGrafoComunidades] = useState('none');
...
//     "Ten en cuenta que estamos analizando un gran volumen de datos",
//     "Tu gráfico se está procesando"
//   ];
...
//     }, 3000); // Cambia 3000 por el tiempo en milisegundos entre cada transición
...
//   useEffect(() => {
//     const drawGraph = () => {
//       const container = document.getElementById('comunidadesEnRedes');
...
//     setTimeout(() => {
//       setShowGraphComunidades(true);
//       setdisplayGrafoComunidades('')
...
//     <Progress percent={progress} style={{ display: showGraphComunidades ? 'none' : '' }} />
  
//     <div style={{ display: showGraphComunidades ? 'none' : '' }}>{phrases[currentPhrase]} </div>
//     <div className='gitloading'><img src={gif} style={{ display: showGraphComunidades ? 'none' : '' }} /></div>
...
//     {display ? 
//     <div>
//     <div className='grafo-video' style={{ display: displayGrafoComunidades }} >
     
    
    
//     <div id="comunidadesEnRedes" className='cartaGrafo' style={{backgroundColor:"black", display: displayGrafoComunidades}}></div>
...
//     <div>
//     <div className='grafo-video' style={{ display: displayGrafoComunidades }} >
//     <div id="comunidadesEnRedes" className='carta2' style={{backgroundColor:"black", display: displayGrafoComunidades}}></div>
