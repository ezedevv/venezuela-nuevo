...
Esta combinación de grafos, proporciona una visión más profunda y precisa de la estructura, y el significado de la información contenida en el texto analizado.
    ...
    <a href={`https://qsngrafos.vercel.app/palabras/medios_instituciones/grafo_palabras-frecuentes-${filtroFecha}.html`} target="_blank"><Button className='boton-abrirnavegador' shape="circle">
        <MdOpenInNew/>
    </Button>
     </a>
    </Tooltip>
    ...
    <div className='bigramas-trigramas'>
      <div id="bigramas" className='carta2' style={{backgroundColor:"#001529"}}></div>
      <Tooltip title='Abrir en otro navegador'>
    <a href={`https://qsngrafos.vercel.app/palabras/medios_instituciones/grafo_bigramas-frecuentes-${filtroFecha}.html`} target="_blank"><Button className='boton-abrirnavegador' shape="circle">
        <MdOpenInNew/>
    </Button>
     </a>
    </Tooltip>
      ...
      <Tooltip title='Abrir en otro navegador'>
    <a href={`https://qsngrafos.vercel.app/palabras/medios_instituciones/grafo_trigramas-frecuentes-${filtroFecha}.html`} target="_blank"><Button className='boton-abrirnavegador' shape="circle">
        <MdOpenInNew/>
    </Button>
     </a>
    </Tooltip>
